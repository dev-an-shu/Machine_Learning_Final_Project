...
extractionLayer2 = 'avg_pool';
xception_trainFeatures = activations(net, trainingSet, extractionLayer2, 'MiniBatchSize', 120);
xception_trainFeatures = reshape(xception_trainFeatures,[1*1*2048,size(xception_trainFeatures,4)])';
xception_testFeatures = activations(net, testingSet, extractionLayer2, 'MiniBatchSize', 120);
